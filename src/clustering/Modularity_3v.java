 ...
 * @author pjmcswee
 */
public class Modularity_3v implements Statistics, LongTask {
    ...
    class CommunityStructure {
        ...
        HashMap<Modularity_3v.Community, Float>[] nodeConnectionsWeight;
        HashMap<Modularity_3v.Community, Integer>[] nodeConnectionsCount;
        ...
        CommunityStructure(Graph graph) {
            ...
            for (Node node : nodesIterable) {
                ...
                for (Node neighbor : uniqueNeighbors) {
                    ...
                    Modularity_3v.ModEdge me = new ModEdge(node_index, neighbor_index, weight);
        ...
        private void addNodeTo(int node, Community to) {
            ...
            for (ModEdge e : topology[node]) {
                ...
                ///////////////////
                Modularity_3v.Community adjCom = nodeCommunities[neighbor];
        ...
        private void zoomOut() {
            ...
            for (int i = 0; i < communities.size(); i++) {//Community com : mCommunities) {
                ...
                for (Modularity_3v.Community adjCom : iter) {
    ...
    class Community {
        ...
        List<Integer> nodes;
        HashMap<Modularity_3v.Community, Float> connectionsWeight;
        HashMap<Modularity_3v.Community, Integer> connectionsCount;

        public int size() {
            return nodes.size();
        }

        public Community(Modularity_3v.Community com) {
    ...
    public void execute(Graph graph) {
        ...
        graph.readLock();
        try {
            structure = new Modularity_3v.CommunityStructure(graph);
