...
public class InitialNetByFU {
    ...
    public static void initial3V(JavaRDD<String> edgeSet,JavaSparkContext sc,String savePath,
                                 Int2ObjectOpenHashMap neigbhor,int partNum_2,String exInPath,String exSavePath) throws IOException {
        ...
        sc.textFile(savePath+"/"+exInPath).repartition(partNum_2).map(new calEdgeDist()).saveAsTextFile(savePath+"/"+exSavePath);
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        initial3V(lines,sc,outputPath,neigbhor,partNum_2,exInPath,exSavePath);
    }
}
